...
export function FloatingMusicButton({ enabled, playing, onToggle }: FloatingMusicButtonProps) {
  return (
    <button
      ...
      className="fixed bottom-24 right-4 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/40 bg-cocoa text-white shadow-soft backdrop-blur md:right-6"
      disabled={!enabled}
    >
